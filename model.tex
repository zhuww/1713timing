...
Position angle of ascending node, $\Omega$ (deg)&  94(10)\tablenotemark{d}\\
...
\tablenotetext{d}{The 1$\sigma$ uncertainty of $\Omega$ is estimated using a $\chi^2$ grid search with all other parameters frozen and $\Delta\chi^2=2.3$.
 }
