...
#m = pickle.load(open('Feb.T2.RN.pkl', 'rb'))
...
tablekeys = [keytable[k] for k in keys]
...
#print 'EFAC:', EFACdic.keys()
#print 'EQUAD:', EQUADdic.keys()
#print 'ECORR:', ECORRdic.keys()
...
data = [tablekeys, avesig, EFAC, EQUAD, ECORR, WRMS, AWRMS]
