...
M. E. Gonzalez\altaffilmark{1}, 
G. Jones\altaffilmark{8}, 
M. T. Lam\altaffilmark{6}, 
L. Levin\altaffilmark{9}, 
M. A. McLaughlin\altaffilmark{9}, 
T. Pennucci\altaffilmark{2}, 
K. Stovall\altaffilmark{10}, 
J. Swiggum\altaffilmark{9}
}
%% --------------------------------------------------------
%% \email{}
%% --------------------------------------------------------
...
2T8, Canada}
\altaffiltext{8}{\footnotesize Columbia University, USA}
\altaffiltext{9}{\footnotesize Department of Physics, West Virginia University, P.O. Box
6315, Morgantown, WV 26505, USA}
\altaffiltext{10}{\footnotesize Department of Physics and Astronomy, University of New
...
separated into two segments with a small DM offset. This offset exists 
because the Mark~IV and ABPP TOAs (before MJD$\sim$53200) are extracted using
using different pulse
...
fitting and manifest a systematic DM offset. The subplot shows the structure
...
2.244(1), different from the value of 1.667 expected from a
...
from the timing residuals of PSR~J1713+0747 obtained by setting $F_2=0$ and freezing all other parameters; blue dots:
...
$\sigma_z(\tau)$ calculated from simulated residuals that also contain a
...
without the FD model, showing the frequency dependency of the TOAs.} 
\end{figure} 
