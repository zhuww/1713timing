...
\altaffiltext{12}{\footnotesize Department of Physics, West Virginia University, P.O. Box
...
\altaffiltext{14}{\footnotesize Max-Planck-Institut für Radioastronomie, Auf
...
%\begin{figure}
%\includegraphics[scale=0.6]{RN.ps} \\ 
...
global maximum likelihood value ($-2.92$) mentioned in the text.}
\end{figure} 
