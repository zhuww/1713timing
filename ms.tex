...
\caption {\label{fig:dmx} The DM variation of PSR~J1713+0747. There is
  an offset
between the DM measurements based on Mark~IV and ABPP data and those
based on
ASP, GASP, GUPPI and PUPPI, because the two set of measurements were based on TOAs  
...
from the timing residuals of PSR~J1713+0747 obtained by setting $F_2=0$ and freezing
...
The simulated residuals have a uniform 10-day cadence.
The step size of the random walk is chosen to
be a Gaussian random value with 1/6 the variance of the actual timing
residuals, which means the characteristic time scale of this red noise
is $\sim$36 simulated epochs, corresponding to $\sim 1$ year.  
} 
\end{figure} 
