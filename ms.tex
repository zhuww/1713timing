...
2T8, Canada}
\altaffiltext{8}{\footnotesize Department of Physics, Columbia University, 550
...
0.244(1), different from the value of $11/3-2$ expected from a
...
the distribution of $\sigma_z(\tau)$ calculated from simulated timing residuals containing 
