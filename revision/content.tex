...
have weighted root mean square $\sim 92$~ns. 
The new dataset allows us to update and improve previous measurements
...
We reanalyzed the \citealt{sns+05} datasets (Mark~III, Mark~IV, and ABPP data)
...
The red noise signal found by our noise model applied to the \cite{sns+05} dataset is consistent with that found 
in the 21 year dataset, both in terms of the noise parameters (Table
...
value and 1$\sigma$ credible interval is very consistent with the GLS solution from \textsc{TEMPO}/\textsc{TEMPO2}. The solid, dashed and dash-dotted lines represent the one, two and three-sigma credible regions, respectively.
} 
\end{figure*} 
