...
of $\sim 210$~ns. We also measured the binary orbit's apparent decay due to 
...
between the pulsar and earth, and it varies because
our sight-line through the turbulent ISM is changing as the pulsar, the Earth, and the ISM all move with respect to each other.
the ISM varies. For most pulsars
...
scale.%with smaller than 1 year of typical timescale. 
...
The great advances in instrumentation have significantly improved the timing residuals and also made the timing model increasingly
accurate.
