...
spin down and proper motion of the pulsar, the mass and 3D orbit of its
companion white dwarf, and a noise model that incorporates short- and
...
attribute this to the relative motion of the binary system and the Earth. We 
...
rate of the Universe. This is the best $\dot{G}/G$ limit from extra-solar
systems.
\end{abstract}
