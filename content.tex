...
of the orbit in the sky, with residuals of weighted root mean square of $\sim 118$~ns. 
...
[1.3(1)~\Msun] and white dwarf [0.290(14)~\Msun] and the parallax
 [$\pi=$0.83(3)~mas].  
\bfref{
We employed modern noise analysis techniques that allow proper modeling of
correlated noises in the data and detecting potential jitter and red noise.
The noise analysis also improved the reliability and robustness of our timing analysis.
}
...
better timing fits ($\Delta\chi^2\sim3$ for 16566 degrees of freedom in both
...
spectral index is inconsistent with the $\gamma_{\rm red} = -2.17^{+0.44}_{-0.09}$
