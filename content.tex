...
deduced from the maximum likelihood red noise realization in the top panel. This is not
a red noise process that reveals itself as a very low frequency sinusoid or cubic but instead
it seems that the red noise is modeling a feature that is localized to the time period of 1999 through 2005.
Since this is when dual-frequency observations begin, it is likely that this is in fact due to DM 
variations that cannot be modeled in the earlier data. Nonetheless, this noise model describes
the data very well ({\bf probably should use other plot here with noise subtracted}) but makes 
physical interpretations of red noise difficuld because of the lack of multi-frequency data at early epochs.
