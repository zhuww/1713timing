...
theory of gravitation and maybe violated in other theories. This principle
...
\end{equation}
where $\textbf{\textit{w}}$ is the absolute velocity of the binary system relate to
micro-wave background, $P$ is the pulsar's spin period, $\beta$ is the
...
Fortunately, most variables in these equations are measurable in the
...
priors for the unmeasurable variables as previously done in \citealt{sns+05,
sfl+05, gsf+11}. Using better constraint parameters from our 20 year data, we found new
limits on the violations of SEP and Lorentz invariance $\Delta < 0.03$ and
$\hat{\alpha}_3<3\times10^{19}$ based on this pulsar binary.
