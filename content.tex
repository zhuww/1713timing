...
of the orbit in the sky, with residuals of estimated variance of $\sim 212$~ns. 
...
\phi$ (EFAC, EQUAD, and ECORR), and find one that maximize the likelihood
function. Our program works in conjunction with the {\sc tempo} software package.
...
%In Section \ref{sec:res} we discuss that  
...
%future.
%After correcting for ``over-fitting'', the ``corrected'' WRMS of the post-fit residuals (Table 
