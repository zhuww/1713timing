...
compared with the 2008 event. As a result, its structure function (Figure \ref{fig:dmx}) follows a
...
%A more realistic noise analysis is needed for the 21-yr data set along the lines of Dolch et~al
%(2014, in preparation).
