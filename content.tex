...
The intrinsic change in orbital period is $-0.20(17)$~ps~s$^{-1}$,
...
The observed red noise level is consistent with the prediction
from the current best upper limit of GW background \citep{src+13}, therefore,
we could not rule out significant timing noise contribution from GW background. 
