...
\bfref{
Through pulse timing analysis, we detect evidences of short-time-scale pulse
jitter noises and long-time-scale red noises in our data.
}
\end{abstract}
...
epoch, time, and frequency independent random noises left in the data. %is generally the dominant source of noise in pulsar timing data.
...
If the timing noises of the sampled pulsars are due to the accumulation of 
spin noises, and the spin noises are caused by the same physical processes,
