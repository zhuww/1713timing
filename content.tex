...
We also find stringent constraint on the apparent variation of the orbital
period due to the system's
...
by the transverse motion of the pulsar binary relative to earth. Luckily, we have good measurements of the distance and proper
...
\citealt{lwj+09} and \citealt{fwe+12} showed that a generic test of $\dot{G}/G$ can be archived using pulsar
...
%a class of realistic alternative gravitational theory --- the 
%scalar-tensor theory.
%In the framework of this theory,
%the scalar field that interacts with the mass changes over time as the
%Universe expands. This change will cause the local value of $G$ to vary. 
...
$\hat{\alpha}_3$ is the strong-field version of the Post-Newtonian
