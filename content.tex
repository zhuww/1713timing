...
[1.29(3)~\Msun] and white dwarf [0.283(4)~\Msun] and the parallax
 [$\pi=$0.893(16)~mas].  
...
$\dot{G}/G$ is found to be $-4(7)\times10^{-13}$~yr$^{-1}$ and at 
...
mostly as part of the NANOGrav project. We started using 
...
including the effects of pulsar spin, astrometry, orbital motion,
...
for the pulsar's spin, spin down and long-term timing noise.
...
measurement $D_{\rm PSR}=$1.12(2)~kpc. This distance is consistent with the
VLBA parallax distance of 1.05(6)~kpc \citep{cbv+09}, but with better accuracy.
...
The Earth's motion could also cause a projected helical motion through the ISM
...
around 2009. Conversely, the overall long-term variation is smaller
...
{\bfref These mechanisms could lead to accumulative random perturbations in the pulsar's phase of
...
b})=1.0\pm2.3\times10^{-11}$~yr$^{-1}$ based on the timing of binary PSR
1913+16.
