...
the timing model is proportional to $e^{-\chi^2/2}$. The code for running this
...
flatter spectrum than the Kolomgorov one.
...
Such timing noise accumulates over time, therefore, often has a ``red'' 
spectrum, meaning that they are often relatively small in short time scale,
but become more significant over time.
