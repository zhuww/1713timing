...
modeled, with residuals of weighted root mean square of $\sim 92$~ns, by the
spin down and proper motion of the pulsar, 
a comprehensive binary model that included the 3-D orientation 
of the orbit in the sky, and a noise model that incorporates short- and
...
[1.31(11)~\Msun] and white dwarf [0.286(12)~\Msun] and the parallax
 [$\pi=$0.87(3)~mas].  
...
$\dot{G}/G$ is found to be $-0.6(1.1)\times10^{-12}$~yr$^{-1}$ and at 
...
constant, $\dot{G}$. Although this constraint is not better than the
best solar system tests, it is nevertheless an independent test using an
extra-solar binary system, and could be particularly constraining for some
