...
from \citet{sc10}. } While the integrated RMS of the red noise is consistent with the prediction of
...
However, as we discussed in Section \ref{sec:noise}, there are other possible
