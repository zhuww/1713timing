...
Observable = OrderedDict([
        ...
        ('KIN',r'Cosine of inclination, $\cos i$'),
...
Caption = '\label{tab:sns05} Comparing the result of red noise anlaysis with eight frequency polynomial used in \cite{sns+05}, using the same datasets. '
colnames = ['Parameter', '\citealt{sns+05}', 'red noise model']
parameter = []
data = []
