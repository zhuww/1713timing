...
\tablenotetext{d}{The model for estimating solar wind contribution in DM:
    DM$_\odot=4.85\times10^{-6}n_0(\pi - \theta)/\sin
    \theta$~cm$^{-3}$~pc \citep{yhc+07}, where $\theta$ is the solar elongation of the pulsar and $n_0$ is the solar wind electron density at 1 AU from the Sun. We fix $n_0$
